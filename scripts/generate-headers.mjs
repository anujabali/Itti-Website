 ...
 * whenever the source does, so a hand-maintained list in a config file would go
...
# Caching. These lived in a host config file until the site moved to Cloudflare
